...
check_curseforge_mod() {
    ...
    local cf_token_enc_url="https://raw.githubusercontent.com/LukeDlbrg/MinecraftSplitscreenBazzite/main/token.enc"
...
resolve_curseforge_dependencies_api() {
    ...
    local token_url="https://raw.githubusercontent.com/LukeDlbrg/MinecraftSplitscreenBazzite/main/token.enc"
